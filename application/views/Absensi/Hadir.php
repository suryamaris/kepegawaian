<h1 style="text-decoration: underline;">Absensi Hadir</h1>
<br>
<table>
    <form action="hadir" method="POST">
        <tr>
            <td>
                <h5 style="color:darkslategrey;">Hadir pada tanggal : </h5>
            </td>
    ...
    <td><a href="<?= base_url('admin/cetakAbsenHadir/' . $cari) ?>" target="_blank"><button class="btn btn-info" style="margin-left: 500px; height:50px">Cetak Laporan</button></a></td>
    </tr>
</table>
<br>
<h4>Tanggal : <?= $cari ?></h4>
