<h1 style="text-decoration: underline;">Data Mutasi</h1>
<table>
    <form action="mutasi" method="POST">
        <tr>
            <td>
                <h5 style="color: black;">Data Mutasi pada Bulan</h5>
            </td>
            <td>&nbsp;&nbsp;&nbsp; : &nbsp;</td>
...
<?php if ($cari) { ?>
    ...
    <td><a href="<?= base_url('admin/cetakTindakanMutasi/' . $bulan) ?>" target="_blank"><button class="btn btn-primary" style="margin-left: 500px;">Cetak Laporan</button></a></td>
    <table class="table">
        <form>
            <tr>
