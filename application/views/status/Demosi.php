<h1 style="text-decoration: underline;">Data Demosi</h1>
<table>
    <form action="demosi" method="POST">
        <tr>
            <td>
                <h5 style="color: black;">Data demosi pada Bulan</h5>
            </td>
            <td>&nbsp;&nbsp;&nbsp; : &nbsp;</td>
...
<?php if ($cari) { ?>
    ...
    <td><a href="<?= base_url('admin/cetakTindakanDemosi/' . $bulan) ?>" target="_blank"><button class="btn btn-primary" style="margin-left: 500px;">Cetak Laporan</button></a></td>
    <table class="table">
        <form>
            <tr>
